...
class CramerGAN(GAN):
    def __init__(self, input_shape, latent_dim = 100, critic_update = 3, **kwargs):
        super(CramerGAN, self).__init__(input_shape, latent_dim , **kwargs)
        self.d_iters = critic_update
    ...
    def train_on_batch(self, batch_size):
        ...
        for _ in range(0, self.d_iters):
            ...
            d_loss += self.disc_model.train_on_batch([imgs, noise_a, noise_b], self.dummy) / self.d_iters
