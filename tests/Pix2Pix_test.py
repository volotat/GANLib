from GANLib import Pix2Pix, distances
...
for i in range(1,5): #len(tests['dataset'])
    ...
    with tf.Session() as sess:
        ...
        gan = Pix2Pix(sess, [set_domain_A.shape[1:], set_domain_B.shape[1:]], distance = tests['distance'][i], n_critic = 3)
        ...
        def callback():
            path = 'images/Pix2Pix/tf_'+tests['img_name'][i]
